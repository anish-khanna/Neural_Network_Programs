...
#This project is in association with the Deep Learning A-Z course by SuperDataScience and is intended as a basis
...
X_train = []
y_train = []
for i in range(60, 1258):   #must be at least 60 points in to use the previous 60
